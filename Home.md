...
- [So What?](So-What)
- [How is Scoop different from Chocolatey or Winget?](Chocolatey-and-Winget-Comparison)
...
- [Can I use Scoop in Bash, Zsh, etc?](Can-I-Use-Scoop-in-Bash,-Zsh,-etc)
- [Example Setup Scripts](Example-Setup-Scripts)
- [Folder layout](Scoop-Folder-Layout)
- [Open With and Icons](Open-With-Icons)
- [PowerShell modules](PowerShell-Modules)
- [Switching Ruby, Python and PHP Versions](Switching-Ruby,-Python-and-PHP-Versions)
